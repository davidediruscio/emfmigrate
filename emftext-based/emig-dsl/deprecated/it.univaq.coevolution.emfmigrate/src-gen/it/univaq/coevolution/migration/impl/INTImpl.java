 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.migration.impl.INTImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class INTImpl extends MinimalEObjectImpl.Container implements INT
{
  ...
  {
    return MigrationPackage.Literals.INT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.INT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MigrationPackage.INT__NAME:
        return getName();
    }
