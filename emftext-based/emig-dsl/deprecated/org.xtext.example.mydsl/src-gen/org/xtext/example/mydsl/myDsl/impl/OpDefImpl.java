 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OpDefImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.OpDefImpl#getSetters <em>Setters</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OpDefImpl extends MinimalEObjectImpl.Container implements OpDef
{
  ...
  {
    return MyDslPackage.Literals.OP_DEF;
  }
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.OP_DEF__OP, oldOp, op));
  }
  ...
  public EList<setterDef> getSetters()
  {
    if (setters == null)
    {
      setters = new EObjectContainmentEList<setterDef>(setterDef.class, this, MyDslPackage.OP_DEF__SETTERS);
    }
    return setters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.OP_DEF__SETTERS:
