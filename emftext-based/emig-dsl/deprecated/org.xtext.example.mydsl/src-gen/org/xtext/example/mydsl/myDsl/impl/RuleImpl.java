 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RuleImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RuleImpl#getRewritingRules <em>Rewriting Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RuleImpl extends MinimalEObjectImpl.Container implements Rule
{
  ...
  public NotificationChain basicSetFilter(OpDef newFilter, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.RULE__FILTER, oldFilter, newFilter);
  ...
  public void setFilter(OpDef newFilter)
  {
    if (newFilter != filter)
    {
      ...
      if (filter != null)
        msgs = ((InternalEObject)filter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RULE__FILTER, null, msgs);
      if (newFilter != null)
        msgs = ((InternalEObject)newFilter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.RULE__FILTER, null, msgs);
      msgs = basicSetFilter(newFilter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.RULE__FILTER, newFilter, newFilter));
  }
  ...
  public EList<RewritingRule> getRewritingRules()
  {
    ...
    {
      rewritingRules = new EObjectContainmentEList<RewritingRule>(RewritingRule.class, this, MyDslPackage.RULE__REWRITING_RULES);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RULE__FILTER:
        return basicSetFilter(null, msgs);
      case MyDslPackage.RULE__REWRITING_RULES:
