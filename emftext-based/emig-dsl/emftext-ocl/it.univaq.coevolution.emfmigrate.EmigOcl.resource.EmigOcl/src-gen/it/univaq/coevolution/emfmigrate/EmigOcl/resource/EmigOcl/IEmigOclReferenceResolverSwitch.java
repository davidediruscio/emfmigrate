...
/**
 * A IEmigOclReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IEmigOclReferenceResolverSwitch extends it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclConfigurable {
