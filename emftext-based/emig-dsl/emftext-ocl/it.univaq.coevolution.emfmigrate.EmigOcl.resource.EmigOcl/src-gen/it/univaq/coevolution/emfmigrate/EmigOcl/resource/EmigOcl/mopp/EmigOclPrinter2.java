...
public class EmigOclPrinter2 implements it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextPrinter {
	...
	protected void doPrint(org.eclipse.emf.ecore.EObject element, java.util.List<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclFormattingElement> foundFormattingElements) {
		...
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.SetType) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_55, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.OclAnyType) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_56, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.TupleType) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_57, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.TupleTypeAttribute) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_58, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.OclModelElement) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_59, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.MapType) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_60, foundFormattingElements);
			return;
		}
		if (element instanceof it.univaq.coevolution.emfmigrate.EmigOcl.LambdaType) {
			printInternal(element, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.EMIGOCL_61, foundFormattingElements);
			return;
		}
