 ...
 */
public class EmigOclPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl";
	/**
	...
	private static EmigOclPlugin plugin;
	
	public EmigOclPlugin() {
		super();
	}
	...
	public static EmigOclPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigOclPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigOclPlugin.PLUGIN_ID, message);
		}
		final EmigOclPlugin pluginInstance = EmigOclPlugin.getDefault();
