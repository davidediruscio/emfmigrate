...
public class EmigOclStackFrame extends it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclDebugTarget target;
	private String name;
	private int id;
	...
	public EmigOclStackFrame(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.util.EmigOclStringUtil.decode(data, ',');
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclStackFrame other = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclStackFrame) obj;
		if (name == null) {
