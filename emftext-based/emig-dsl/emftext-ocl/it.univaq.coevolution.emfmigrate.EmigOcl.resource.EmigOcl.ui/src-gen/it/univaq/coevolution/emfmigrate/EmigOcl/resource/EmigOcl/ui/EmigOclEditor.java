...
/**
 * A text editor for 'EmigOcl' models.
 */
public class EmigOclEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclResourceProvider, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclBracketHandlerProvider, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclAnnotationModelProvider {
	
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclCodeFoldingManager codeFoldingManager;
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBackgroundParsingStrategy bgParsingStrategy = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBackgroundParsingStrategy();
	private java.util.Collection<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBackgroundParsingListener>();
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclColorManager colorManager = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclColorManager();
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclOutlinePage outlinePage;
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPropertySheetPage propertySheetPage;
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclBracketHandler bracketHandler;
	...
	public EmigOclEditor() {
		super();
		setSourceViewerConfiguration(new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), EmigOclEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource currentResource = getResource();
				...
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.EditorContext");
		setRulerContextMenuId("it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclNature.activate(inputFile.getProject());
		...
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource loadedResource = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource) {
					setResource((it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the EmigOclEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource textResource = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource) element.eResource();
			...
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextToken token = lexer.getNextToken();
			...
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!EmigOclEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclBracketHandler bracketHandler) {
