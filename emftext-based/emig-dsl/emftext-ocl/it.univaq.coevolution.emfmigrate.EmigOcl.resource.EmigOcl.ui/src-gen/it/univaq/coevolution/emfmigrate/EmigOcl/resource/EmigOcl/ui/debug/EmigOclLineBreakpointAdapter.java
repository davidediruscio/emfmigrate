...
public class EmigOclLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclPlugin.DEBUG_MODEL_ID);
			...
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclLineBreakpoint lineBreakpoint = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.debug.EmigOclLineBreakpoint(resource, lineNumber + 1);
