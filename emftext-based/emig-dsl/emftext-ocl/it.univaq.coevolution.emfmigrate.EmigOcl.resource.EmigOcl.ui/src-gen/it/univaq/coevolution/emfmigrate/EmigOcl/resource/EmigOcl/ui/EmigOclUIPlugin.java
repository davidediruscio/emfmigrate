 ...
 */
public class EmigOclUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui";
	public static final String EDITOR_ID = "it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor";
	...
	private static EmigOclUIPlugin plugin;
	
	public EmigOclUIPlugin() {
		super();
	}
	...
	public static EmigOclUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigOclUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigOclUIPlugin.PLUGIN_ID, message);
		}
		final EmigOclUIPlugin pluginInstance = EmigOclUIPlugin.getDefault();
