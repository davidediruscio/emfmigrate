 ...
 */
public class EmigOclTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput infoInput = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHyperlink hyperlink = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl iControl = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput) {
							it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput input = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl.isAvailable(parent)) {
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl iControl = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public EmigOclTextHover(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.insertPageProlog(buffer, 0, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclTextHover.getStyleSheet());
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.addPageEpilog(buffer);
			return new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.util.EmigOclStreamUtil.getContent(styleSheetURL.openStream());
