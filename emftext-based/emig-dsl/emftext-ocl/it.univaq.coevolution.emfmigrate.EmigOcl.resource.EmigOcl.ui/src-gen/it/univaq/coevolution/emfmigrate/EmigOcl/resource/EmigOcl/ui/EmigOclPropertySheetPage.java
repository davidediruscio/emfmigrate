...
public class EmigOclPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEObjectSelection) {
			final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEObjectSelection selection = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEObjectSelection) iSelection;
