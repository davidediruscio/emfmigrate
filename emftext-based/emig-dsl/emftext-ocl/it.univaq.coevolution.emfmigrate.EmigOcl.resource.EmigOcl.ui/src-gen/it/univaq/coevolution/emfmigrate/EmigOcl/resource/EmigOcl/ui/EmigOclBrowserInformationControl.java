 ...
 * @since 3.2
 */
public class EmigOclBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EmigOclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EmigOclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EmigOclBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput);
		...
		fInput= (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput) input;
		...
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclDocBrowserInformationControlInput getInput() {
		return fInput;
	}
