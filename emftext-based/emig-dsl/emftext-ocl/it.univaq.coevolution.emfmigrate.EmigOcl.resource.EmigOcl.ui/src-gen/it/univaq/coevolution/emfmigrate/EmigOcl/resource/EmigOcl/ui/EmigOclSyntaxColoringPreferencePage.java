 ...
 */
public class EmigOclSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public EmigOclSyntaxColoringPreferencePage() {
		super();
		
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclMetaInformation syntaxPlugin = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPixelConverter pixelConverter = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor) {
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor emfTextEditor = (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor) editor;
