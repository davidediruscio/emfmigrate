 ...
 */
public class EmigOclHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EmigOclHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
