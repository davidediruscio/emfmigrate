...
public class EmigOclAnnotationModelFactory implements org.eclipse.core.filebuffers.IAnnotationModelFactory {
	...
	public org.eclipse.jface.text.source.IAnnotationModel createAnnotationModel(org.eclipse.core.runtime.IPath location) {
		...
		return new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclAnnotationModel(resource);
	}
