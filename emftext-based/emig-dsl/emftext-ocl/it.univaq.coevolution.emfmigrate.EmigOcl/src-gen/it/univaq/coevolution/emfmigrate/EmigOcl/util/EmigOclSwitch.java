 ...
 * @generated
 */
public class EmigOclSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EmigOclPackage.OCL_EXPRESSION: {
			...
			case EmigOclPackage.VARIABLE_EXP: {
			...
			case EmigOclPackage.STRING_EXP: {
			...
			case EmigOclPackage.BOOLEAN_EXP: {
			...
			case EmigOclPackage.NUMERIC_EXP: {
			...
			case EmigOclPackage.INTEGER_EXP: {
			...
			case EmigOclPackage.COLLECTION_EXP: {
			...
			case EmigOclPackage.ORDERED_SET_EXP: {
			...
			case EmigOclPackage.SEQUENCE_EXP: {
			...
			case EmigOclPackage.TUPLE_PART: {
			...
			case EmigOclPackage.MAP_ELEMENT: {
			...
			case EmigOclPackage.ENUM_LITERAL_EXP: {
			...
			case EmigOclPackage.OCL_UNDEFINED_EXP: {
			...
			case EmigOclPackage.STATIC_PROPERTY_CALL_EXP: {
			...
			case EmigOclPackage.STATIC_OPERATION_CALL: {
			...
			case EmigOclPackage.PROPERTY_CALL_EXP: {
			...
			case EmigOclPackage.OPERATION_CALL: {
			...
			case EmigOclPackage.OPERATOR_CALL_EXP: {
			...
			case EmigOclPackage.EQ_OP_CALL_EXP: {
			...
			case EmigOclPackage.LAMBDA_CALL_EXP: {
			...
			case EmigOclPackage.COLLECTION_OPERATION_CALL: {
			...
			case EmigOclPackage.ITERATE_EXP: {
			...
			case EmigOclPackage.ITERATOR_EXP: {
			...
			case EmigOclPackage.VARIABLE_DECLARATION: {
			...
			case EmigOclPackage.LOCAL_VARIABLE: {
			...
			case EmigOclPackage.COLLECTION_TYPE: {
			...
			case EmigOclPackage.STRING_TYPE: {
			...
			case EmigOclPackage.BOOLEAN_TYPE: {
			...
			case EmigOclPackage.NUMERIC_TYPE: {
			...
			case EmigOclPackage.INTEGER_TYPE: {
			...
			case EmigOclPackage.ORDERED_SET_TYPE: {
			...
			case EmigOclPackage.SEQUENCE_TYPE: {
			...
			case EmigOclPackage.OCL_ANY_TYPE: {
			...
			case EmigOclPackage.TUPLE_TYPE: {
			...
			case EmigOclPackage.TUPLE_TYPE_ATTRIBUTE: {
			...
			case EmigOclPackage.OCL_MODEL_ELEMENT: {
			...
			case EmigOclPackage.LAMBDA_TYPE: {
			...
			case EmigOclPackage.OCL_FEATURE_DEFINITION: {
			...
			case EmigOclPackage.OCL_CONTEXT_DEFINITION: {
			...
			case EmigOclPackage.OCL_FEATURE: {
