...
public class IterateExpImpl extends LoopExpImpl implements IterateExp {
	...
	public void setResult(LocalVariable newResult) {
		if (newResult != result) {
			...
			if (result != null)
				msgs = ((InternalEObject)result).eInverseRemove(this, EmigOclPackage.LOCAL_VARIABLE__BASE_EXP, LocalVariable.class, msgs);
			if (newResult != null)
				msgs = ((InternalEObject)newResult).eInverseAdd(this, EmigOclPackage.LOCAL_VARIABLE__BASE_EXP, LocalVariable.class, msgs);
