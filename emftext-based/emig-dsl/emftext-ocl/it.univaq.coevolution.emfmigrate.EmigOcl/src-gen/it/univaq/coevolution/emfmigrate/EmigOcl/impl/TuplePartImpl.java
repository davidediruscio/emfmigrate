 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.TuplePartImpl#getTuple <em>Tuple</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TuplePartImpl extends LocalVariableImpl implements TuplePart {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.TUPLE_PART;
	}
	...
	public TupleExp getTuple() {
		if (eContainerFeatureID() != EmigOclPackage.TUPLE_PART__TUPLE) return null;
	...
	public NotificationChain basicSetTuple(TupleExp newTuple, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTuple, EmigOclPackage.TUPLE_PART__TUPLE, msgs);
		return msgs;
	}
	...
	public void setTuple(TupleExp newTuple) {
		if (newTuple != eInternalContainer() || (eContainerFeatureID() != EmigOclPackage.TUPLE_PART__TUPLE && newTuple != null)) {
			...
			if (newTuple != null)
				msgs = ((InternalEObject)newTuple).eInverseAdd(this, EmigOclPackage.TUPLE_EXP__TUPLE_PART, TupleExp.class, msgs);
			msgs = basicSetTuple(newTuple, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.TUPLE_PART__TUPLE, newTuple, newTuple));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.TUPLE_PART__TUPLE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case EmigOclPackage.TUPLE_PART__TUPLE:
				return eInternalContainer().eInverseRemove(this, EmigOclPackage.TUPLE_EXP__TUPLE_PART, TupleExp.class, msgs);
		}
