 ...
 * @generated
 */
public class EmigOclPackageImpl extends EPackageImpl implements EmigOclPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see it.univaq.coevolution.emfmigrate.EmigOcl.EmigOclPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private EmigOclPackageImpl() {
		super(eNS_URI, EmigOclFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link EmigOclPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static EmigOclPackage init() {
		if (isInited) return (EmigOclPackage)EPackage.Registry.INSTANCE.getEPackage(EmigOclPackage.eNS_URI);

		// Obtain or create and register package
		EmigOclPackageImpl theEmigOclPackage = (EmigOclPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EmigOclPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EmigOclPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theEmigOclPackage.createPackageContents();

		// Initialize created meta-data
		theEmigOclPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theEmigOclPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(EmigOclPackage.eNS_URI, theEmigOclPackage);
		return theEmigOclPackage;
	}
	 ...
	 * @generated
	 */
	public EmigOclFactory getEmigOclFactory() {
		return (EmigOclFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getStaticPropertyCallExp_Source(), this.getOclType(), null, "source", null, 1, 1, StaticPropertyCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getStaticPropertyCallExp_StaticCall(), this.getStaticPropertyCall(), null, "staticCall", null, 1, 1, StaticPropertyCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getPropertyCallExp_Calls(), this.getPropertyCall(), null, "calls", null, 1, -1, PropertyCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLambdaType_ReturnType(), this.getOclType(), null, "returnType", null, 1, 1, LambdaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLambdaType_ArgumentTypes(), this.getOclType(), null, "argumentTypes", null, 0, -1, LambdaType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
