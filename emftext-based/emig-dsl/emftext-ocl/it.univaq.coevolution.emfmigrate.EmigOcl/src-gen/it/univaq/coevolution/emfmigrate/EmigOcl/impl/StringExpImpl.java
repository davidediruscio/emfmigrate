 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.StringExpImpl#getStringSymbol <em>String Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringExpImpl extends PrimitiveExpImpl implements StringExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.STRING_EXP;
	}
	...
	public void setStringSymbol(String newStringSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.STRING_EXP__STRING_SYMBOL, oldStringSymbol, stringSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.STRING_EXP__STRING_SYMBOL:
