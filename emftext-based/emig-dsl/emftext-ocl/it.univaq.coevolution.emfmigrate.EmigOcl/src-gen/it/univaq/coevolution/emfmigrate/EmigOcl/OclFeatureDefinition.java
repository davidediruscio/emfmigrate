 ...
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.OclFeatureDefinition#isStatic <em>Static</em>}</li>
 * </ul>
 * </p>
 *
...
public interface OclFeatureDefinition extends LocatedElement {
	 ...
	 * @see it.univaq.coevolution.emfmigrate.EmigOcl.EmigOclPackage#getOclFeatureDefinition_Static()
	 * @model dataType="it.univaq.coevolution.emfmigrate.EmigOcl.Boolean" required="true"
	 * @generated
	 */
	boolean isStatic();

	/**
	 * Sets the value of the '{@link it.univaq.coevolution.emfmigrate.EmigOcl.OclFeatureDefinition#isStatic <em>Static</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
