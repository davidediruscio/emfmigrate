 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.CollectionExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CollectionExpImpl extends OclExpressionImpl implements CollectionExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.COLLECTION_EXP;
	}
	...
	public EList<OclExpression> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<OclExpression>(OclExpression.class, this, EmigOclPackage.COLLECTION_EXP__ELEMENTS, EmigOclPackage.OCL_EXPRESSION__COLLECTION);
		}
		return elements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.COLLECTION_EXP__ELEMENTS:
