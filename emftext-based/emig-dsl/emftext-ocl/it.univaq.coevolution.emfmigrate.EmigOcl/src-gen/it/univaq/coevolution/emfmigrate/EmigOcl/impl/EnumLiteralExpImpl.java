 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.EnumLiteralExpImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumLiteralExpImpl extends OclExpressionImpl implements EnumLiteralExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.ENUM_LITERAL_EXP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.ENUM_LITERAL_EXP__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.ENUM_LITERAL_EXP__NAME:
				return getName();
		}
