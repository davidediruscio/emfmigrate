 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.RealExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealExpImpl extends NumericExpImpl implements RealExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.REAL_EXP;
	}
	...
	public void setRealSymbol(double newRealSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.REAL_EXP__REAL_SYMBOL, oldRealSymbol, realSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.REAL_EXP__REAL_SYMBOL:
