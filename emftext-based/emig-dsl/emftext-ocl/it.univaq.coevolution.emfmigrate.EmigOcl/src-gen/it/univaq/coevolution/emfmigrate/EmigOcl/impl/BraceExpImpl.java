 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.BraceExpImpl#getExp <em>Exp</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BraceExpImpl extends OclExpressionImpl implements BraceExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.BRACE_EXP;
	}
	...
	public NotificationChain basicSetExp(OclExpression newExp, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmigOclPackage.BRACE_EXP__EXP, oldExp, newExp);
	...
	public void setExp(OclExpression newExp) {
		if (newExp != exp) {
			...
			if (exp != null)
				msgs = ((InternalEObject)exp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EmigOclPackage.BRACE_EXP__EXP, null, msgs);
			if (newExp != null)
				msgs = ((InternalEObject)newExp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EmigOclPackage.BRACE_EXP__EXP, null, msgs);
			msgs = basicSetExp(newExp, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.BRACE_EXP__EXP, newExp, newExp));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.BRACE_EXP__EXP:
