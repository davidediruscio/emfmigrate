 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.RealExpImpl#getRealSymbol <em>Real Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RealExpImpl extends NumericExpImpl implements RealExp {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.REAL_EXP;
	}
	...
	public void setRealSymbol(double newRealSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLinEmigPackage.REAL_EXP__REAL_SYMBOL, oldRealSymbol, realSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLinEmigPackage.REAL_EXP__REAL_SYMBOL:
