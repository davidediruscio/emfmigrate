 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.BooleanExpImpl#isBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpImpl extends PrimitiveExpImpl implements BooleanExp {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.BOOLEAN_EXP;
	}
	...
	public void setBooleanSymbol(boolean newBooleanSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLinEmigPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLinEmigPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL:
