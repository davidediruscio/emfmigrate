 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.LocatedElementImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link OCLinEmig.impl.LocatedElementImpl#getCommentsBefore <em>Comments Before</em>}</li>
 *   <li>{@link OCLinEmig.impl.LocatedElementImpl#getCommentsAfter <em>Comments After</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class LocatedElementImpl extends EObjectImpl implements LocatedElement {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.LOCATED_ELEMENT;
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLinEmigPackage.LOCATED_ELEMENT__LOCATION, oldLocation, location));
	}
	...
	public EList<String> getCommentsBefore() {
		if (commentsBefore == null) {
			commentsBefore = new EDataTypeEList<String>(String.class, this, OCLinEmigPackage.LOCATED_ELEMENT__COMMENTS_BEFORE);
		}
	...
	public EList<String> getCommentsAfter() {
		if (commentsAfter == null) {
			commentsAfter = new EDataTypeEList<String>(String.class, this, OCLinEmigPackage.LOCATED_ELEMENT__COMMENTS_AFTER);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLinEmigPackage.LOCATED_ELEMENT__LOCATION:
				return getLocation();
			case OCLinEmigPackage.LOCATED_ELEMENT__COMMENTS_BEFORE:
				return getCommentsBefore();
			case OCLinEmigPackage.LOCATED_ELEMENT__COMMENTS_AFTER:
