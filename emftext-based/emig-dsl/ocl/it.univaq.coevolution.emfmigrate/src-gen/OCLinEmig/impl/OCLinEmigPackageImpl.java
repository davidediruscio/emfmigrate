...
import OCLinEmig.BagExp;
import OCLinEmig.BagType;
import OCLinEmig.BooleanExp;
import OCLinEmig.BooleanType;
import OCLinEmig.CollectionExp;
import OCLinEmig.CollectionOperationCallExp;
import OCLinEmig.CollectionType;
import OCLinEmig.EnumLiteralExp;
import OCLinEmig.IfExp;
import OCLinEmig.IntegerExp;
import OCLinEmig.IntegerType;
import OCLinEmig.IterateExp;
import OCLinEmig.Iterator;
import OCLinEmig.IteratorExp;
import OCLinEmig.LetExp;
import OCLinEmig.LocatedElement;
import OCLinEmig.LoopExp;
import OCLinEmig.MapElement;
import OCLinEmig.MapExp;
import OCLinEmig.MapType;
import OCLinEmig.Module;
import OCLinEmig.NavigationOrAttributeCallExp;
import OCLinEmig.NumericExp;
import OCLinEmig.NumericType;
import OCLinEmig.OCLinEmigFactory;
import OCLinEmig.OCLinEmigPackage;
import OCLinEmig.OclAnyType;
import OCLinEmig.OclContextDefinition;
import OCLinEmig.OclExpression;
import OCLinEmig.OclFeature;
import OCLinEmig.OclFeatureDefinition;
import OCLinEmig.OclModel;
import OCLinEmig.OclModelElement;
import OCLinEmig.OclType;
import OCLinEmig.OclUndefinedExp;
import OCLinEmig.Operation;
import OCLinEmig.OperationCallExp;
import OCLinEmig.OperatorCallExp;
import OCLinEmig.OrderedSetExp;
import OCLinEmig.OrderedSetType;
import OCLinEmig.Parameter;
import OCLinEmig.Primitive;
import OCLinEmig.PrimitiveExp;
import OCLinEmig.PropertyCallExp;
import OCLinEmig.RealExp;
import OCLinEmig.RealType;
import OCLinEmig.SequenceExp;
import OCLinEmig.SequenceType;
import OCLinEmig.SetExp;
import OCLinEmig.SetType;
import OCLinEmig.StringExp;
import OCLinEmig.StringType;
import OCLinEmig.SuperExp;
 ...
 * @generated
 */
public class OCLinEmigPackageImpl extends EPackageImpl implements OCLinEmigPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see OCLinEmig.OCLinEmigPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private OCLinEmigPackageImpl() {
		super(eNS_URI, OCLinEmigFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link OCLinEmigPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static OCLinEmigPackage init() {
		if (isInited) return (OCLinEmigPackage)EPackage.Registry.INSTANCE.getEPackage(OCLinEmigPackage.eNS_URI);

		// Obtain or create and register package
		OCLinEmigPackageImpl theOCLinEmigPackage = (OCLinEmigPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof OCLinEmigPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new OCLinEmigPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theOCLinEmigPackage.createPackageContents();

		// Initialize created meta-data
		theOCLinEmigPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theOCLinEmigPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(OCLinEmigPackage.eNS_URI, theOCLinEmigPackage);
		return theOCLinEmigPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getModule_OclFeatures() {
	 ...
	 * @generated
	 */
	public OCLinEmigFactory getOCLinEmigFactory() {
		return (OCLinEmigFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(moduleEClass, MODULE__OCL_FEATURES);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getNavigationOrAttributeCallExp_Name(), this.getString(), "name", null, 1, 1, NavigationOrAttributeCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getOperationCallExp_OperationName(), this.getString(), "operationName", null, 1, 1, OperationCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getVariableDeclaration_Id(), this.getString(), "id", null, 0, 1, VariableDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		...
		initEAttribute(getLocatedElement_Location(), this.getString(), "location", null, 0, 1, LocatedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
		initEAttribute(getLocatedElement_CommentsBefore(), this.getString(), "commentsBefore", null, 0, -1, LocatedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLocatedElement_CommentsAfter(), this.getString(), "commentsAfter", null, 0, -1, LocatedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(moduleEClass, Module.class, "Module", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModule_OclFeatures(), this.getOclFeatureDefinition(), null, "oclFeatures", null, 0, -1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getModule_Name(), this.getString(), "name", null, 0, 1, Module.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
