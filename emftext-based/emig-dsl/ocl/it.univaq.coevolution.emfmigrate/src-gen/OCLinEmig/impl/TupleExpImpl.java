 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.TupleExpImpl#getTuplePart <em>Tuple Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleExpImpl extends OclExpressionImpl implements TupleExp {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.TUPLE_EXP;
	}
	...
	public EList<TuplePart> getTuplePart() {
		if (tuplePart == null) {
			tuplePart = new EObjectContainmentWithInverseEList<TuplePart>(TuplePart.class, this, OCLinEmigPackage.TUPLE_EXP__TUPLE_PART, OCLinEmigPackage.TUPLE_PART__TUPLE);
		}
		return tuplePart;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OCLinEmigPackage.TUPLE_EXP__TUPLE_PART:
