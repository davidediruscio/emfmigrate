 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.IntegerExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerExpImpl extends NumericExpImpl implements IntegerExp {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.INTEGER_EXP;
	}
	...
	public void setIntegerSymbol(int newIntegerSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OCLinEmigPackage.INTEGER_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OCLinEmigPackage.INTEGER_EXP__INTEGER_SYMBOL:
