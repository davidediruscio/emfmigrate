 ...
 * <ul>
 *   <li>{@link OCLinEmig.impl.CollectionExpImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class CollectionExpImpl extends OclExpressionImpl implements CollectionExp {
	...
	protected EClass eStaticClass() {
		return OCLinEmigPackage.Literals.COLLECTION_EXP;
	}
	...
	public EList<OclExpression> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<OclExpression>(OclExpression.class, this, OCLinEmigPackage.COLLECTION_EXP__ELEMENTS, OCLinEmigPackage.OCL_EXPRESSION__COLLECTION);
		}
		return elements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OCLinEmigPackage.COLLECTION_EXP__ELEMENTS:
