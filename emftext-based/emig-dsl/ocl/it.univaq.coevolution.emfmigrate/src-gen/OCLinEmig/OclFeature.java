 ...
 * <ul>
 *   <li>{@link OCLinEmig.OclFeature#getDefinition <em>Definition</em>}</li>
 * </ul>
 * </p>
 *
 * @see OCLinEmig.OCLinEmigPackage#getOclFeature()
 * @model abstract="true"
 * @generated
 */
public interface OclFeature extends LocatedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link OCLinEmig.OclFeatureDefinition#getFeature <em>Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see OCLinEmig.OCLinEmigPackage#getOclFeature_Definition()
	...
	/**
	 * Sets the value of the '{@link OCLinEmig.OclFeature#getDefinition <em>Definition</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
