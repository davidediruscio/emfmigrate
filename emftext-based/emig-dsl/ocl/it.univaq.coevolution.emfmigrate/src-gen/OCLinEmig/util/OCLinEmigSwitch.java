 ...
 * @generated
 */
public class OCLinEmigSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case OCLinEmigPackage.OCL_EXPRESSION: {
			...
			case OCLinEmigPackage.VARIABLE_EXP: {
			...
			case OCLinEmigPackage.SUPER_EXP: {
			...
			case OCLinEmigPackage.PRIMITIVE_EXP: {
			...
			case OCLinEmigPackage.STRING_EXP: {
			...
			case OCLinEmigPackage.BOOLEAN_EXP: {
			...
			case OCLinEmigPackage.NUMERIC_EXP: {
			...
			case OCLinEmigPackage.REAL_EXP: {
			...
			case OCLinEmigPackage.INTEGER_EXP: {
			...
			case OCLinEmigPackage.COLLECTION_EXP: {
			...
			case OCLinEmigPackage.ORDERED_SET_EXP: {
			...
			case OCLinEmigPackage.SEQUENCE_EXP: {
			...
			case OCLinEmigPackage.TUPLE_EXP: {
			...
			case OCLinEmigPackage.TUPLE_PART: {
			...
			case OCLinEmigPackage.MAP_ELEMENT: {
			...
			case OCLinEmigPackage.ENUM_LITERAL_EXP: {
			...
			case OCLinEmigPackage.OCL_UNDEFINED_EXP: {
			...
			case OCLinEmigPackage.PROPERTY_CALL_EXP: {
			...
			case OCLinEmigPackage.NAVIGATION_OR_ATTRIBUTE_CALL_EXP: {
			...
			case OCLinEmigPackage.OPERATION_CALL_EXP: {
			...
			case OCLinEmigPackage.OPERATOR_CALL_EXP: {
			...
			case OCLinEmigPackage.COLLECTION_OPERATION_CALL_EXP: {
			...
			case OCLinEmigPackage.LOOP_EXP: {
			...
			case OCLinEmigPackage.ITERATE_EXP: {
			...
			case OCLinEmigPackage.ITERATOR_EXP: {
			...
			case OCLinEmigPackage.VARIABLE_DECLARATION: {
			...
			case OCLinEmigPackage.ITERATOR: {
			...
			case OCLinEmigPackage.PARAMETER: {
			...
			case OCLinEmigPackage.COLLECTION_TYPE: {
			...
			case OCLinEmigPackage.OCL_TYPE: {
			...
			case OCLinEmigPackage.PRIMITIVE: {
			...
			case OCLinEmigPackage.STRING_TYPE: {
			...
			case OCLinEmigPackage.BOOLEAN_TYPE: {
			...
			case OCLinEmigPackage.NUMERIC_TYPE: {
			...
			case OCLinEmigPackage.INTEGER_TYPE: {
			...
			case OCLinEmigPackage.REAL_TYPE: {
			...
			case OCLinEmigPackage.BAG_TYPE: {
			...
			case OCLinEmigPackage.ORDERED_SET_TYPE: {
			...
			case OCLinEmigPackage.SEQUENCE_TYPE: {
			...
			case OCLinEmigPackage.SET_TYPE: {
			...
			case OCLinEmigPackage.OCL_ANY_TYPE: {
			...
			case OCLinEmigPackage.TUPLE_TYPE: {
			...
			case OCLinEmigPackage.TUPLE_TYPE_ATTRIBUTE: {
			...
			case OCLinEmigPackage.OCL_MODEL_ELEMENT: {
			...
			case OCLinEmigPackage.MAP_TYPE: {
			...
			case OCLinEmigPackage.OCL_FEATURE_DEFINITION: {
			...
			case OCLinEmigPackage.OCL_CONTEXT_DEFINITION: {
			...
			case OCLinEmigPackage.OCL_FEATURE: {
			...
			case OCLinEmigPackage.ATTRIBUTE: {
			...
			case OCLinEmigPackage.OPERATION: {
			...
			case OCLinEmigPackage.OCL_MODEL: {
