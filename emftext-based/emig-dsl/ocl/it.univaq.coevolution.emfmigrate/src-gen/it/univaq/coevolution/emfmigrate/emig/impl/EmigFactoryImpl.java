...
public class EmigFactoryImpl extends EFactoryImpl implements EmigFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case EmigPackage.NAVIGATION_OR_ATTRIBUTE_CALL_EXP: return createNavigationOrAttributeCallExp();
      case EmigPackage.VARIABLE_EXP: return createVariableExp();
      case EmigPackage.SUPER_EXP: return createSuperExp();
      case EmigPackage.BAG_EXP: return createBagExp();
      case EmigPackage.ORDERED_SET_EXP: return createOrderedSetExp();
      case EmigPackage.SEQUENCE_EXP: return createSequenceExp();
      case EmigPackage.SET_EXP: return createSetExp();
      case EmigPackage.TUPLE_EXP: return createTupleExp();
      case EmigPackage.MAP_EXP: return createMapExp();
      case EmigPackage.OCL_UNDEFINED_EXP: return createOclUndefinedExp();
      default:
