...
public class EmigPackageImpl extends EPackageImpl implements EmigPackage
{
   ...
   * @see it.univaq.coevolution.emfmigrate.emig.EmigPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static EmigPackage init()
  {
    ...
    OCLinEmigPackage.eINSTANCE.eClass();
   ...
   * @generated
   */
  public EReference getMigratorSX_Name()
  {
  ...
  {
    return (EAttribute)migratorDXEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getFilterMigrator_Specification()
  {
   ...
   * @generated
   */
  public EReference getNavigationOrAttributeCallExp_Src()
  {
    return (EReference)navigationOrAttributeCallExpEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(migratorSXEClass, MIGRATOR_SX__NAME);
    ...
    createEReference(filterMigratorEClass, FILTER_MIGRATOR__SPECIFICATION);
    ...
    createEReference(navigationOrAttributeCallExpEClass, NAVIGATION_OR_ATTRIBUTE_CALL_EXP__SRC);
  ...
  public void initializePackageContents()
  {
    ...
    OCLinEmigPackage theOCLinEmigPackage = (OCLinEmigPackage)EPackage.Registry.INSTANCE.getEPackage(OCLinEmigPackage.eNS_URI);
    ...
    navigationOrAttributeCallExpEClass.getESuperTypes().add(theOCLinEmigPackage.getOclExpression());
    variableExpEClass.getESuperTypes().add(theOCLinEmigPackage.getVariableExp());
    superExpEClass.getESuperTypes().add(theOCLinEmigPackage.getSuperExp());
    bagExpEClass.getESuperTypes().add(theOCLinEmigPackage.getBagExp());
    orderedSetExpEClass.getESuperTypes().add(theOCLinEmigPackage.getOrderedSetExp());
    sequenceExpEClass.getESuperTypes().add(theOCLinEmigPackage.getSequenceExp());
    setExpEClass.getESuperTypes().add(theOCLinEmigPackage.getSetExp());
    tupleExpEClass.getESuperTypes().add(theOCLinEmigPackage.getTupleExp());
    mapExpEClass.getESuperTypes().add(theOCLinEmigPackage.getMapExp());
    oclUndefinedExpEClass.getESuperTypes().add(theOCLinEmigPackage.getOclUndefinedExp());
    ...
    initEReference(getMigratorSX_Name(), theOCLinEmigPackage.getVariableDeclaration(), null, "name", null, 0, 1, MigratorSX.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getFilterMigrator_Specification(), theOCLinEmigPackage.getOclExpression(), null, "specification", null, 0, 1, FilterMigrator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(packageEClass, it.univaq.coevolution.emfmigrate.emig.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(classEClass, it.univaq.coevolution.emfmigrate.emig.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    ...
    initEReference(getNavigationOrAttributeCallExp_Src(), theOCLinEmigPackage.getOclExpression(), null, "src", null, 0, 1, NavigationOrAttributeCallExp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
