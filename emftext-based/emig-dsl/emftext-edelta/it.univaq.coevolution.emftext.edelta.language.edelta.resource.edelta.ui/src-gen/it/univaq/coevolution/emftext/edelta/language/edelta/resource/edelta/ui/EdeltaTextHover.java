 ...
 */
public class EdeltaTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput infoInput = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHyperlink hyperlink = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl iControl = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput) {
							it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput input = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl.isAvailable(parent)) {
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl iControl = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public EdeltaTextHover(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.insertPageProlog(buffer, 0, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaTextHover.getStyleSheet());
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.addPageEpilog(buffer);
			return new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaStreamUtil.getContent(styleSheetURL.openStream());
