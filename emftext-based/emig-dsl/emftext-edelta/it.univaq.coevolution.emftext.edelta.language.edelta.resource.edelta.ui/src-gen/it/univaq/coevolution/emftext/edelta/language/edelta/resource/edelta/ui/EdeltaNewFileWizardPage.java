 ...
 */
public class EdeltaNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EdeltaNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new edelta file");
