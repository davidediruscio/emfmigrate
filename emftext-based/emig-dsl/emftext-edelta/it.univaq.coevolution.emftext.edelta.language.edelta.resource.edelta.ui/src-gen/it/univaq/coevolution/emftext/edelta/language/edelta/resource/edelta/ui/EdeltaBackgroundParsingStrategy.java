 ...
 */
public class EdeltaBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource resource, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource resource, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource resource, final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
