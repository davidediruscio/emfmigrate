 ...
 */
public class EdeltaLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.launch.EdeltaLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaPlugin.logError("Exception while launching selection", e);
		}
	}
