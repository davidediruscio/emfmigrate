 ...
 */
public class EdeltaCodeFoldingManager {
	
	private class FoldingUpdateListener implements it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor) {
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor) workbenchPart;
	...
	protected it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor;
	 ...
	 */
	public EdeltaCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor textEditor) {
	...
	private void addCloseListener(final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource textResource = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
