 ...
 * @since 3.2
 */
public class EdeltaBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput fInput;
	 ...
	 */
	public EdeltaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public EdeltaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public EdeltaBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput);
		...
		fInput= (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput) input;
		...
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaDocBrowserInformationControlInput getInput() {
		return fInput;
	}
