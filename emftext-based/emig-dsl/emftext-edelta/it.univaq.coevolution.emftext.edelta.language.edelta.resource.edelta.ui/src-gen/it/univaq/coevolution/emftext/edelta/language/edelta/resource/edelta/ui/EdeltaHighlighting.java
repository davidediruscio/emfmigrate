 ...
 */
public class EdeltaHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionHelper positionHelper = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionHelper();
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaTokenScanner scanner;
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaOccurrence occurrence;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public EdeltaHighlighting(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaColorManager colorManager, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaTokenScanner(textResource, colorManager);
		occurrence = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
