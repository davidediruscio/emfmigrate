...
public class EdeltaPropertySheetPage extends org.eclipse.ui.views.properties.PropertySheetPage implements org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public void selectionChanged(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection iSelection) {
		...
		if (iSelection instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEObjectSelection) {
			final it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEObjectSelection selection = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEObjectSelection) iSelection;
