 ...
 */
public class EdeltaOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.outlinecontext";
	...
	public EdeltaOutlinePage(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor textEditor) {
		super();
		this.editor = textEditor;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.outlinecontext", menuManager, treeViewer);
	}
