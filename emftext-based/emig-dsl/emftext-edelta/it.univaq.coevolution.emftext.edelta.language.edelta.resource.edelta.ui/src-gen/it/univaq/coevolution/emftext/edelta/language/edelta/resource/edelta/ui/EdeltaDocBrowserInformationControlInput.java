 ...
 * olInput</code>.
 */
public class EdeltaDocBrowserInformationControlInput {
	
	private final EdeltaDocBrowserInformationControlInput fPrevious;
	private EdeltaDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EdeltaDocBrowserInformationControlInput(EdeltaDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EdeltaDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EdeltaDocBrowserInformationControlInput getNext() {
		return fNext;
	}
