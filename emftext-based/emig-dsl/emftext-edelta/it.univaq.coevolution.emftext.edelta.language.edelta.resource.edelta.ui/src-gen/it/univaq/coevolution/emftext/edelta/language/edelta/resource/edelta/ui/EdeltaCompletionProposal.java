 ...
 */
public class EdeltaCompletionProposal implements java.lang.Comparable<EdeltaCompletionProposal> {
	...
	public EdeltaCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EdeltaCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EdeltaCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof EdeltaCompletionProposal) {
			EdeltaCompletionProposal other = (EdeltaCompletionProposal) object;
	...
	public int compareTo(EdeltaCompletionProposal object) {
		if (object instanceof EdeltaCompletionProposal) {
			EdeltaCompletionProposal other = (EdeltaCompletionProposal) object;
