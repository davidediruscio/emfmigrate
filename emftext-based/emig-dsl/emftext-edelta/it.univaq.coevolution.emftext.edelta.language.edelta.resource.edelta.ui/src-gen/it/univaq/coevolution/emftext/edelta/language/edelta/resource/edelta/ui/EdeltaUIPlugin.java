 ...
 */
public class EdeltaUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui";
	public static final String EDITOR_ID = "it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor";
	...
	private static EdeltaUIPlugin plugin;
	
	public EdeltaUIPlugin() {
		super();
	}
	...
	public static EdeltaUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdeltaUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdeltaUIPlugin.PLUGIN_ID, message);
		}
		final EdeltaUIPlugin pluginInstance = EdeltaUIPlugin.getDefault();
