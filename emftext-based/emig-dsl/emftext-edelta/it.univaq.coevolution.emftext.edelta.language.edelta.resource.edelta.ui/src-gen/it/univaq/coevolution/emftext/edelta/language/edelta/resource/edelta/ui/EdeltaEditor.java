...
/**
 * A text editor for 'edelta' models.
 */
public class EdeltaEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaResourceProvider, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaBracketHandlerProvider, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaAnnotationModelProvider {
	
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaCodeFoldingManager codeFoldingManager;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBackgroundParsingStrategy bgParsingStrategy = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaBackgroundParsingStrategy();
	private java.util.Collection<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener>();
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaColorManager colorManager = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaColorManager();
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaOutlinePage outlinePage;
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPropertySheetPage propertySheetPage;
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaBracketHandler bracketHandler;
	...
	public EdeltaEditor() {
		super();
		setSourceViewerConfiguration(new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), EdeltaEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource currentResource = getResource();
				...
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.EditorContext");
		setRulerContextMenuId("it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaNature.activate(inputFile.getProject());
		...
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource loadedResource = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource) {
					setResource((it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the EdeltaEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource textResource = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextResource) element.eResource();
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTextToken token = lexer.getNextToken();
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!EdeltaEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaBracketHandler bracketHandler) {
