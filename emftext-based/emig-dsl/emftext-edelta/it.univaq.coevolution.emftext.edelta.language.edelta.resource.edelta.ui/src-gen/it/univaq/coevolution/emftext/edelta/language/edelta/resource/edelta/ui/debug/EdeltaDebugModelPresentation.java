...
public class EdeltaDebugModelPresentation implements org.eclipse.debug.ui.IDebugModelPresentation {
	
	public EdeltaDebugModelPresentation() {
		super();
	}
	...
	public String getEditorId(org.eclipse.ui.IEditorInput input, Object element) {
		if (element instanceof org.eclipse.core.resources.IFile || element instanceof org.eclipse.debug.core.model.ILineBreakpoint) {
			return it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.EDITOR_ID;
		}
		return null;
	}
