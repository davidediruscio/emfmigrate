 ...
 */
public class EdeltaSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public EdeltaSyntaxColoringPreferencePage() {
		super();
		
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaMetaInformation syntaxPlugin = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPixelConverter pixelConverter = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor) {
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor emfTextEditor = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor) editor;
