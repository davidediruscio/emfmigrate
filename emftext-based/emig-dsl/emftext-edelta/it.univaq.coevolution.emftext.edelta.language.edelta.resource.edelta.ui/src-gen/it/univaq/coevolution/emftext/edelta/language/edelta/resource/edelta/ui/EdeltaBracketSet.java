...
public class EdeltaBracketSet {
	...
	private java.util.ArrayList<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair {
	 ...
	 */
	private class ClosingListener implements it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.IEdeltaBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public EdeltaBracketSet(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair>();
	 ...
	 */
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair getBracketPair(String opening, String closing) {
		for (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair bracketPair : bracketPairs) {
	...
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair remove(String opening, String closing) {
		for (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
