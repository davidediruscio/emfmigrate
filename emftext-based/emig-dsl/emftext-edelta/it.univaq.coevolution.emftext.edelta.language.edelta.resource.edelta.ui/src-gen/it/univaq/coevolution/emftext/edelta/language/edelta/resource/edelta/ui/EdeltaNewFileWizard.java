...
public class EdeltaNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public EdeltaNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.ui.EdeltaUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation().getSyntaxName();
	}
