 ...
 */
public class EdeltaDefaultTokenResolver implements it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTokenResolver {
	 ...
	 */
	public EdeltaDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public EdeltaDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.grammar.EdeltaGrammarInformationProvider.INSTANCE.getKeywords()) {
