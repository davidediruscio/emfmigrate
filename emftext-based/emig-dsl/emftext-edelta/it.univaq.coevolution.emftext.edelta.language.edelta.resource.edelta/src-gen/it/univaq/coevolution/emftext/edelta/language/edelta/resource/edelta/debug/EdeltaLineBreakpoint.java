...
public class EdeltaLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.lineBreakpoint.marker";
	
	public EdeltaLineBreakpoint() {
		super();
	}
	
	public EdeltaLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget target) {
		try {
	...
	public void remove(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
