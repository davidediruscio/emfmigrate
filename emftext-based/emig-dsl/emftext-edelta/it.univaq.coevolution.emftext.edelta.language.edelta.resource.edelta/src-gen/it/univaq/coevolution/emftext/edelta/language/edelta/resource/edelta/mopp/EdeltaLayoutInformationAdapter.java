...
/**
 * A EdeltaLayoutInformationAdapter is used to store layout information that is
 ...
 * EdeltaLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class EdeltaLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaLayoutInformation> layoutInformations = new java.util.ArrayList<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaLayoutInformation>();
	...
	public java.util.List<it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaLayoutInformation layoutInformation) {
