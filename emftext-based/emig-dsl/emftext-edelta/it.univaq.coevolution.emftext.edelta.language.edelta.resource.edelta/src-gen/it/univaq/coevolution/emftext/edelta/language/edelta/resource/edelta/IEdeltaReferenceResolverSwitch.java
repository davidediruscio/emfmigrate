...
/**
 * A IEdeltaReferenceResolverSwitch holds references to multiple other reference
 * resolvers and delegates requests to the appropriate resolver.
 */
public interface IEdeltaReferenceResolverSwitch extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaConfigurable {
