 ...
 */
public class EdeltaEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaPlugin.logError("Exception while matching proxy URI.", e);
