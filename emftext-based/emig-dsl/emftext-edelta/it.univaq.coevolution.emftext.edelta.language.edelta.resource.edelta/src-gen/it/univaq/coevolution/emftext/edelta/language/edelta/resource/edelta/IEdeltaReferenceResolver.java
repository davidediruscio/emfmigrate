 ...
 * resolver
 */
public interface IEdeltaReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaReferenceResolveResult<ReferenceType> result);
