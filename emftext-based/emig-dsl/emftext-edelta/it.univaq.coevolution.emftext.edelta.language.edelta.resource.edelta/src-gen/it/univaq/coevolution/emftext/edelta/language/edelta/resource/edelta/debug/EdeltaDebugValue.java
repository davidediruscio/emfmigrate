...
public class EdeltaDebugValue extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public EdeltaDebugValue(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
