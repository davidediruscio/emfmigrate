 ...
 * to 4 bytes).
 */
public class EdeltaUnicodeConverter extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaInputStreamProcessor {
	 ...
	 */
	public EdeltaUnicodeConverter(java.io.InputStream inputStream) {
