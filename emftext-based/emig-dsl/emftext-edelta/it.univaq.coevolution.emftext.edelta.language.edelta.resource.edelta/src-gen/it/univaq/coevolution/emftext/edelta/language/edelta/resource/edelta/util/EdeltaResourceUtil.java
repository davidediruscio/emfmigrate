 ...
 */
public class EdeltaResourceUtil {
	...
	public static it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaResource) csResource;
	}
	
	public static it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaResource getResource(java.io.File file) {
	...
	public static it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.mopp.EdeltaResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static it.univaq.coevolution.emftext.edelta.language.edelta.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static it.univaq.coevolution.emftext.edelta.language.edelta.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (it.univaq.coevolution.emftext.edelta.language.edelta.Model) root;
	}
