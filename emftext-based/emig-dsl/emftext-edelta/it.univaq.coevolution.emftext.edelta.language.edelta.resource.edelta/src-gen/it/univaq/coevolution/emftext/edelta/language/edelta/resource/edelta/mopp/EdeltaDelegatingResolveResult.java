 ...
 * result
 */
public class EdeltaDelegatingResolveResult<ReferenceType> implements it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaReferenceResolveResult<ReferenceType> {
	
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaReferenceResolveResult<ReferenceType> delegate;
	
	public EdeltaDelegatingResolveResult(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaReferenceResolveResult<ReferenceType> delegate) {
