 ...
 * instance of EdeltaDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see
 * it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.analysis.Ed
 * eltaDefaultTokenResolver
 */
public interface IEdeltaTokenResolver extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaConfigurable {
