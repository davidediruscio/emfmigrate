...
public class EdeltaStackFrame extends it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget target;
	private String name;
	private int id;
	...
	public EdeltaStackFrame(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaStringUtil.decode(data, ',');
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaStackFrame other = (it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaStackFrame) obj;
		if (name == null) {
