 ...
 * code).
 */
public class EdeltaDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.AbstractEdeltaDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaPair<String, Object>>();
	...
	public EdeltaDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EdeltaDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaStringUtil.encode('#', stack);
			...
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.EEdeltaDebugMessageTypes.GET_VARIABLES)) {
	...
	private String convertToString(long id, Object object) {
		...
		return it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaPair<String, Object> pair = new it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.util.EdeltaPair<String, Object>(name, value);
	...
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.AbstractEdeltaDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.debug.AbstractEdeltaDebuggable debuggable) {
