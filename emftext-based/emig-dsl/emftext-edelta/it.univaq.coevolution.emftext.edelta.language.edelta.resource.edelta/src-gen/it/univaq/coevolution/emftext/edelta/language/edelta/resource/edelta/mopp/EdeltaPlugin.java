 ...
 */
public class EdeltaPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta";
	/**
	...
	private static EdeltaPlugin plugin;
	...
	public static EdeltaPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdeltaPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EdeltaPlugin.PLUGIN_ID, message);
		}
		final EdeltaPlugin pluginInstance = EdeltaPlugin.getDefault();
