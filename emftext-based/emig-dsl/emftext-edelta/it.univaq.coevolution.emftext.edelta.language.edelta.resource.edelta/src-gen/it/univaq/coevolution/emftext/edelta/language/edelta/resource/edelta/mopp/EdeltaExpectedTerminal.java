 ...
 */
public class EdeltaExpectedTerminal {
	
	private int followSetID;
	private it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaExpectedElement terminal;
	...
	public EdeltaExpectedTerminal(it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public it.univaq.coevolution.emftext.edelta.language.edelta.resource.edelta.IEdeltaExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((EdeltaExpectedTerminal) o).terminal);
	}
