...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>delete Package</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.deletePackageImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.deletePackageImpl#getExt <em>Ext</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class deletePackageImpl extends PackageOperationImpl implements deletePackage {
	/**
	...
	protected EClass eStaticClass() {
		return EdeltaPackage.Literals.DELETE_PACKAGE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdeltaPackage.DELETE_PACKAGE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(it.univaq.coevolution.emftext.edelta.language.edelta.Package newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.DELETE_PACKAGE__REF, oldRef, ref));
	}
	...
	public void setExt(String newExt) {
		...
		ext = newExt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.DELETE_PACKAGE__EXT, oldExt, ext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdeltaPackage.DELETE_PACKAGE__REF:
				if (resolve) return getRef();
				return basicGetRef();
			case EdeltaPackage.DELETE_PACKAGE__EXT:
				return getExt();
		}
