...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>change Attribute</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.changeAttributeImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.changeAttributeImpl#getExt <em>Ext</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class changeAttributeImpl extends AttributeOperationImpl implements changeAttribute {
	/**
	...
	protected EClass eStaticClass() {
		return EdeltaPackage.Literals.CHANGE_ATTRIBUTE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdeltaPackage.CHANGE_ATTRIBUTE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Attribute newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.CHANGE_ATTRIBUTE__REF, oldRef, ref));
	}
	...
	public void setExt(String newExt) {
		...
		ext = newExt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.CHANGE_ATTRIBUTE__EXT, oldExt, ext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdeltaPackage.CHANGE_ATTRIBUTE__REF:
				if (resolve) return getRef();
				return basicGetRef();
			case EdeltaPackage.CHANGE_ATTRIBUTE__EXT:
				return getExt();
		}
