 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.deleteReferenceImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.deleteReferenceImpl#getExt <em>Ext</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class deleteReferenceImpl extends ReferenceOperationImpl implements deleteReference {
	/**
	...
	protected EClass eStaticClass() {
		return EdeltaPackage.Literals.DELETE_REFERENCE;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdeltaPackage.DELETE_REFERENCE__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(Reference newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.DELETE_REFERENCE__REF, oldRef, ref));
	}
	...
	public void setExt(String newExt) {
		...
		ext = newExt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.DELETE_REFERENCE__EXT, oldExt, ext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdeltaPackage.DELETE_REFERENCE__REF:
				if (resolve) return getRef();
				return basicGetRef();
			case EdeltaPackage.DELETE_REFERENCE__EXT:
				return getExt();
		}
