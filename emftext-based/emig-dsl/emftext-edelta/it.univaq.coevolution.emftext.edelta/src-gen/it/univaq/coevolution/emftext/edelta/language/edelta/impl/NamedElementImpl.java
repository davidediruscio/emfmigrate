 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.NamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedElementImpl extends EObjectImpl implements NamedElement
{
  ...
  {
		return EdeltaPackage.Literals.NAMED_ELEMENT;
	}
  ...
  public void setName(String newName)
  {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.NAMED_ELEMENT__NAME, oldName, name));
	}
  ...
  {
		switch (featureID) {
			case EdeltaPackage.NAMED_ELEMENT__NAME:
				return getName();
		}
