 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.changeClassImpl#getRef <em>Ref</em>}</li>
 *   <li>{@link it.univaq.coevolution.emftext.edelta.language.edelta.impl.changeClassImpl#getExt <em>Ext</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class changeClassImpl extends ClassOperationImpl implements changeClass {
	/**
	...
	protected EClass eStaticClass() {
		return EdeltaPackage.Literals.CHANGE_CLASS;
	}
		...
		if (ref != null && ref.eIsProxy()) {
			...
			if (ref != oldRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EdeltaPackage.CHANGE_CLASS__REF, oldRef, ref));
			}
		}
		return ref;
	}
	...
	public void setRef(it.univaq.coevolution.emftext.edelta.language.edelta.Class newRef) {
		...
		ref = newRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.CHANGE_CLASS__REF, oldRef, ref));
	}
	...
	public void setExt(String newExt) {
		...
		ext = newExt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EdeltaPackage.CHANGE_CLASS__EXT, oldExt, ext));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EdeltaPackage.CHANGE_CLASS__REF:
				if (resolve) return getRef();
				return basicGetRef();
			case EdeltaPackage.CHANGE_CLASS__EXT:
				return getExt();
		}
