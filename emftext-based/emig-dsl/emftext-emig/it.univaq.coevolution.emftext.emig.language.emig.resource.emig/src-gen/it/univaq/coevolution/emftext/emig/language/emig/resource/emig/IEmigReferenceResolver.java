 ...
 * resolver
 */
public interface IEmigReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigReferenceResolveResult<ReferenceType> result);
