 ...
 * contains
 * <code>it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextDi
 * agnostic</code>s it uses the more precise information of this extended
 * diagnostic type.
 */
public class EmigMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object>> commands = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object>> commandsToProcess = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextDiagnostic diagnostic) {
		final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigProblem problem = diagnostic.getProblem();
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemSeverity.ERROR) {
					...
					it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextDiagnostic textDiagnostic = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType nextType : it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	private static String getMarkerID(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EmigEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.logError("Error while removing markers from resource:", ce);
		}
	}
}
