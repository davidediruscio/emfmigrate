...
/**
 * A EmigLayoutInformation is used to store layout information that is found while
 ...
 * EmigLayoutInformations are aggregated in LayoutInformationAdapters. One
 * EmigLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class EmigLayoutInformation {
	
	private final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.grammar.EmigSyntaxElement syntaxElement;
	...
	public EmigLayoutInformation(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.grammar.EmigSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.grammar.EmigSyntaxElement getSyntaxElement() {
