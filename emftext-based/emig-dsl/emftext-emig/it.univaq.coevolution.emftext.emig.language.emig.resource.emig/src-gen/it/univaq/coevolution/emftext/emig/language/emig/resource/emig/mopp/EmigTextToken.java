...
public class EmigTextToken implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextToken {
	
	private final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigMetaInformation metaInformation = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public EmigTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
