...
public class EmigNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "it.univaq.coevolution.emftext.emig.language.emig.resource.emig.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
