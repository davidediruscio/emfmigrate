...
/**
 * A EmigLayoutInformationAdapter is used to store layout information that is
 ...
 * EmigLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class EmigLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigLayoutInformation> layoutInformations = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigLayoutInformation>();
	...
	public java.util.List<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigLayoutInformation layoutInformation) {
