 ...
 * code).
 */
public class EmigDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.AbstractEmigDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigPair<String, Object>>();
	...
	public EmigDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigStringUtil.encode('#', stack);
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage message = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage message = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_VARIABLES)) {
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage message = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugMessage(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EEmigDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigPair<String, Object> pair = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigPair<String, Object>(name, value);
	...
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.AbstractEmigDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.AbstractEmigDebuggable debuggable) {
