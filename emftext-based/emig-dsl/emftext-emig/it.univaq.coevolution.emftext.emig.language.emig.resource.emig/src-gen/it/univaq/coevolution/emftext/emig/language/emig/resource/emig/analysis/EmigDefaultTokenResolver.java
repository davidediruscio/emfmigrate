 ...
 */
public class EmigDefaultTokenResolver implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTokenResolver {
	 ...
	 */
	public EmigDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public EmigDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : it.univaq.coevolution.emftext.emig.language.emig.resource.emig.grammar.EmigGrammarInformationProvider.INSTANCE.getKeywords()) {
