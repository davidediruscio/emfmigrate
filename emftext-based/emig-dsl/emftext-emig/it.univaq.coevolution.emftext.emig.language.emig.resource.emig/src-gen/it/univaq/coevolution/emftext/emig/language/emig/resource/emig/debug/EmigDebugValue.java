...
public class EmigDebugValue extends it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugElement implements org.eclipse.debug.core.model.IValue {
	...
	public EmigDebugValue(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget target, String id, String valueString, String referenceTypeName, java.util.Map<String, Long> children) {
		super(target);
