...
public abstract class EmigQuickFix implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix {
	...
	public EmigQuickFix(String displayString, String imageKey, org.eclipse.emf.ecore.EObject contextObject) {
		this(displayString, imageKey, java.util.Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public EmigQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public EmigQuickFix(String displayString, String imageKey, java.util.Collection<org.eclipse.emf.ecore.EObject> contextObjects, org.eclipse.emf.ecore.resource.Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.logError("Exception while applying quick fix", e);
		}
		return null;
	}
