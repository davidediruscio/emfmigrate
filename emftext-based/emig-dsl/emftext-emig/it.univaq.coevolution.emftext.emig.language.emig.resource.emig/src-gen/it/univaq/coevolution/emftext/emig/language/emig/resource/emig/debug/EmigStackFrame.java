...
public class EmigStackFrame extends it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget target;
	private String name;
	private int id;
	...
	public EmigStackFrame(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigStringUtil.decode(data, ',');
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigStackFrame other = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigStackFrame) obj;
		if (name == null) {
