 ...
 */
public class AbstractEmigInterpreter<ResultType, ContextType> {
	
	private java.util.Stack<org.eclipse.emf.ecore.EObject> interpretationStack = new java.util.Stack<org.eclipse.emf.ecore.EObject>();
	private java.util.List<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigInterpreterListener> listeners = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigInterpreterListener>();
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.MParameter) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_MParameter((it.univaq.coevolution.emftext.emig.language.emig.MParameter) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.SetterDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_SetterDef((it.univaq.coevolution.emftext.emig.language.emig.SetterDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Reference) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Reference((it.univaq.coevolution.emftext.emig.language.emig.Reference) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.ReferenceOpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_ReferenceOpDef((it.univaq.coevolution.emftext.emig.language.emig.ReferenceOpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Attribute) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Attribute((it.univaq.coevolution.emftext.emig.language.emig.Attribute) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Feature) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Feature((it.univaq.coevolution.emftext.emig.language.emig.Feature) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.AttributeOpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_AttributeOpDef((it.univaq.coevolution.emftext.emig.language.emig.AttributeOpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.FeatureOpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_FeatureOpDef((it.univaq.coevolution.emftext.emig.language.emig.FeatureOpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Class) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Class((it.univaq.coevolution.emftext.emig.language.emig.Class) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.ClassOpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_ClassOpDef((it.univaq.coevolution.emftext.emig.language.emig.ClassOpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Package) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Package((it.univaq.coevolution.emftext.emig.language.emig.Package) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.PackageOpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_PackageOpDef((it.univaq.coevolution.emftext.emig.language.emig.PackageOpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.OpDef) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_OpDef((it.univaq.coevolution.emftext.emig.language.emig.OpDef) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.RightRuleElement) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_RightRuleElement((it.univaq.coevolution.emftext.emig.language.emig.RightRuleElement) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.LeftRuleElement) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_LeftRuleElement((it.univaq.coevolution.emftext.emig.language.emig.LeftRuleElement) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Binding) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Binding((it.univaq.coevolution.emftext.emig.language.emig.Binding) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.RewritingRule) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_RewritingRule((it.univaq.coevolution.emftext.emig.language.emig.RewritingRule) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.Rule) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_Rule((it.univaq.coevolution.emftext.emig.language.emig.Rule) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.MigrationProgram) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_MigrationProgram((it.univaq.coevolution.emftext.emig.language.emig.MigrationProgram) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emftext.emig.language.emig.MigrationLibrary) {
			result = interprete_it_univaq_coevolution_emftext_emig_language_emig_MigrationLibrary((it.univaq.coevolution.emftext.emig.language.emig.MigrationLibrary) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_MigrationLibrary(it.univaq.coevolution.emftext.emig.language.emig.MigrationLibrary object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_MigrationProgram(it.univaq.coevolution.emftext.emig.language.emig.MigrationProgram object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Rule(it.univaq.coevolution.emftext.emig.language.emig.Rule object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_RewritingRule(it.univaq.coevolution.emftext.emig.language.emig.RewritingRule object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Binding(it.univaq.coevolution.emftext.emig.language.emig.Binding object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_LeftRuleElement(it.univaq.coevolution.emftext.emig.language.emig.LeftRuleElement object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_RightRuleElement(it.univaq.coevolution.emftext.emig.language.emig.RightRuleElement object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_OpDef(it.univaq.coevolution.emftext.emig.language.emig.OpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_PackageOpDef(it.univaq.coevolution.emftext.emig.language.emig.PackageOpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Package(it.univaq.coevolution.emftext.emig.language.emig.Package object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_ClassOpDef(it.univaq.coevolution.emftext.emig.language.emig.ClassOpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Class(it.univaq.coevolution.emftext.emig.language.emig.Class object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_FeatureOpDef(it.univaq.coevolution.emftext.emig.language.emig.FeatureOpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_AttributeOpDef(it.univaq.coevolution.emftext.emig.language.emig.AttributeOpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Feature(it.univaq.coevolution.emftext.emig.language.emig.Feature object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Attribute(it.univaq.coevolution.emftext.emig.language.emig.Attribute object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_ReferenceOpDef(it.univaq.coevolution.emftext.emig.language.emig.ReferenceOpDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_Reference(it.univaq.coevolution.emftext.emig.language.emig.Reference object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_SetterDef(it.univaq.coevolution.emftext.emig.language.emig.SetterDef object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emftext_emig_language_emig_MParameter(it.univaq.coevolution.emftext.emig.language.emig.MParameter object, ContextType context) {
		return null;
	}
	...
	private void notifyListeners(org.eclipse.emf.ecore.EObject element) {
		for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigInterpreterListener listener : listeners) {
	...
	public void addListener(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigInterpreterListener newListener) {
		listeners.add(newListener);
	}
	
	public boolean removeListener(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigInterpreterListener listener) {
