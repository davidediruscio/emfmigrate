...
public class VariableExpReferredVariableReferenceResolver implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigReferenceResolver<be.ac.vub.simpleocl.VariableExp, be.ac.vub.simpleocl.VariableDeclaration> {
	...
	public void resolve(String identifier, be.ac.vub.simpleocl.VariableExp container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigReferenceResolveResult<be.ac.vub.simpleocl.VariableDeclaration> result) {
