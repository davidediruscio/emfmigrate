...
public class OclModelElementModelReferenceResolver implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigReferenceResolver<be.ac.vub.simpleocl.OclModelElement, be.ac.vub.simpleocl.OclModel> {
	...
	public void resolve(String identifier, be.ac.vub.simpleocl.OclModelElement container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigReferenceResolveResult<be.ac.vub.simpleocl.OclModel> result) {
