...
public class EmigLineBreakpoint extends org.eclipse.debug.core.model.LineBreakpoint {
	
	private static final String LINE_BREAKPOINT_MARKER_ID = "it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.lineBreakpoint.marker";
	
	public EmigLineBreakpoint() {
		super();
	}
	
	public EmigLineBreakpoint(final org.eclipse.core.resources.IResource resource, final int lineNumber) throws org.eclipse.debug.core.DebugException {
	...
	public void install(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget target) {
		try {
	...
	public void remove(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugTarget target) {
		try {
			String location = (String) getMarker().getAttribute(org.eclipse.core.resources.IMarker.LOCATION);
