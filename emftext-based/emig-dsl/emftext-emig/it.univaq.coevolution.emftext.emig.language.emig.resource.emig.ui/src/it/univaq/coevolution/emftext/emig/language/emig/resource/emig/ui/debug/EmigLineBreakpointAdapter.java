...
public class EmigLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.DEBUG_MODEL_ID);
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigLineBreakpoint lineBreakpoint = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigLineBreakpoint(resource, lineNumber + 1);
