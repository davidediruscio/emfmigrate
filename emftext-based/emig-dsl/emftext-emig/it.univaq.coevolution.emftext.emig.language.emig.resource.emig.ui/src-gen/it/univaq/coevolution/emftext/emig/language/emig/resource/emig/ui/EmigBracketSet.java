...
public class EmigBracketSet {
	...
	private java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair {
	 ...
	 */
	private class ClosingListener implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public EmigBracketSet(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair>();
	 ...
	 */
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair getBracketPair(String opening, String closing) {
		for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair bracketPair : bracketPairs) {
	...
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair remove(String opening, String closing) {
		for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
