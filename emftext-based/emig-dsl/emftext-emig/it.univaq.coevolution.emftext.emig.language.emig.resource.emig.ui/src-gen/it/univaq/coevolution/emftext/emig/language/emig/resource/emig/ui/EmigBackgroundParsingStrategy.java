 ...
 */
public class EmigBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource resource, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource resource, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource resource, final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
