 ...
 */
public class EmigHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionHelper positionHelper = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionHelper();
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigTokenScanner scanner;
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigOccurrence occurrence;
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public EmigHighlighting(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigColorManager colorManager, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigTokenScanner(textResource, colorManager);
		occurrence = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
