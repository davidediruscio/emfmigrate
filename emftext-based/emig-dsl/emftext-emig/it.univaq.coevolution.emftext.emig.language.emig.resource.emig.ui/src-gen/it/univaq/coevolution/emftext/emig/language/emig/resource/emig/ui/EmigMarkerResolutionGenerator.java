...
public class EmigMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigResource) {
					it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigResource customResource = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix> getQuickFixes(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
