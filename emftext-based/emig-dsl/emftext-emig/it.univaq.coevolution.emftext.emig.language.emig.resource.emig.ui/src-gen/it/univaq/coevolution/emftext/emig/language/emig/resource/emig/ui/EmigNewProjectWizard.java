 ...
 */
public class EmigNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui");
							...
							String natureID = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigNature.NATURE_ID;
							...
							for (String builderID : it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation info = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation();
