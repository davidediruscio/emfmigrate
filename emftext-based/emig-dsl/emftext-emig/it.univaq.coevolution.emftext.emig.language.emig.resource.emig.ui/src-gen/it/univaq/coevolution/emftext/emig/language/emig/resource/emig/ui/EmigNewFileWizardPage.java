 ...
 */
public class EmigNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EmigNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new emig file");
