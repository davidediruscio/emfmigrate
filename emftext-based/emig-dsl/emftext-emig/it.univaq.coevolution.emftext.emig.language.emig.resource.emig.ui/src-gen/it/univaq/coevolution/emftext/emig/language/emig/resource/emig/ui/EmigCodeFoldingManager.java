 ...
 */
public class EmigCodeFoldingManager {
	
	private class FoldingUpdateListener implements it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor) {
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor) workbenchPart;
	...
	protected it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor;
	 ...
	 */
	public EmigCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor textEditor) {
	...
	private void addCloseListener(final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource textResource = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
