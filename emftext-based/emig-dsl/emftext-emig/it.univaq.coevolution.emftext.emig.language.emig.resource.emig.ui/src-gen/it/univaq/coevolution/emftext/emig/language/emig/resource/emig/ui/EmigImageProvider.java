 ...
 */
public class EmigImageProvider {
	
	public final static EmigImageProvider INSTANCE = new EmigImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
