 ...
 */
public class EmigSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public EmigSyntaxColoringPreferencePage() {
		super();
		
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigMetaInformation syntaxPlugin = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPixelConverter pixelConverter = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor) {
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor emfTextEditor = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor) editor;
