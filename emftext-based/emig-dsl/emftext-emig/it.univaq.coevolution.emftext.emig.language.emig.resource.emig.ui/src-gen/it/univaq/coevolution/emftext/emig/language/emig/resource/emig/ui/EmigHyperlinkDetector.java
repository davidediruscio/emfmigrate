 ...
 * hovers, is a proxy.
 */
public class EmigHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	 ...
	 */
	public EmigHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) resource;
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlink[] detectHyperlinks(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion region, boolean canShowMultipleHyperlinks) {
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);
