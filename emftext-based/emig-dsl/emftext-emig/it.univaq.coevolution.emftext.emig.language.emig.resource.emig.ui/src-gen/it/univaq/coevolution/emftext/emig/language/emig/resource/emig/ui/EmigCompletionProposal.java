 ...
 */
public class EmigCompletionProposal implements java.lang.Comparable<EmigCompletionProposal> {
	...
	public EmigCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EmigCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EmigCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof EmigCompletionProposal) {
			EmigCompletionProposal other = (EmigCompletionProposal) object;
	...
	public int compareTo(EmigCompletionProposal object) {
		if (object instanceof EmigCompletionProposal) {
			EmigCompletionProposal other = (EmigCompletionProposal) object;
