 ...
 */
public class EmigHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public EmigHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
