 ...
 * 
 */
package it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.debug;

@SuppressWarnings("restriction")
public class EmigAdapterFactory implements org.eclipse.core.runtime.IAdapterFactory {
	...
	public Object getAdapter(Object adaptableObject, Class adapterType) {
		if (adaptableObject instanceof org.eclipse.ui.texteditor.ITextEditor) {
			...
			if (resource != null) {
				...
				if (extension != null && extension.equals(new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigMetaInformation().getSyntaxName())) {
					return new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.debug.EmigLineBreakpointAdapter();
				}
			}
		}
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementLabelProvider.class && adaptableObject instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable) {
			final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable variable = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable) adaptableObject;
		...
		if (adapterType == org.eclipse.debug.internal.ui.viewers.model.provisional.IElementContentProvider.class && adaptableObject instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable) {
			final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable variable = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugVariable) adaptableObject;
				...
				public void update(org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate[] updates) {
					try {
						for (org.eclipse.debug.internal.ui.viewers.model.provisional.IChildrenCountUpdate update : updates) {
							...
							it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugValue castedValue = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.debug.EmigDebugValue) value;
