 ...
 */
public class EmigUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui";
	public static final String EDITOR_ID = "it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditor";
	...
	private static EmigUIPlugin plugin;
	...
	public static EmigUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, EmigUIPlugin.PLUGIN_ID, message);
		}
		final EmigUIPlugin pluginInstance = EmigUIPlugin.getDefault();
