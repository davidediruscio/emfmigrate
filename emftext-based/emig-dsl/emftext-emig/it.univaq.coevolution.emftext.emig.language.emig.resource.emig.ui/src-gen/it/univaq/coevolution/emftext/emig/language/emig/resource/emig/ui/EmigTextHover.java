 ...
 */
public class EmigTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput infoInput = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHyperlink hyperlink = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl iControl = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput) {
							it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput input = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl.isAvailable(parent)) {
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl iControl = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public EmigTextHover(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHTMLPrinter.insertPageProlog(buffer, 0, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigTextHover.getStyleSheet());
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHTMLPrinter.addPageEpilog(buffer);
			return new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return it.univaq.coevolution.emftext.emig.language.emig.resource.emig.util.EmigStreamUtil.getContent(styleSheetURL.openStream());
