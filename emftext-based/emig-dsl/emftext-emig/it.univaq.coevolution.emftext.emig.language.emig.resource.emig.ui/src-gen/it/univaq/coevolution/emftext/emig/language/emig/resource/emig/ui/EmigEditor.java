...
/**
 * A text editor for 'emig' models.
 */
public class EmigEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigResourceProvider, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigBracketHandlerProvider, it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigAnnotationModelProvider {
	
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigCodeFoldingManager codeFoldingManager;
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBackgroundParsingStrategy bgParsingStrategy = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigBackgroundParsingStrategy();
	private java.util.Collection<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener>();
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigColorManager colorManager = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigColorManager();
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigOutlinePage outlinePage;
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPropertySheetPage propertySheetPage;
	...
	private it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigBracketHandler bracketHandler;
	...
	public EmigEditor() {
		super();
		setSourceViewerConfiguration(new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), EmigEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource currentResource = getResource();
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EditorContext");
		setRulerContextMenuId("it.univaq.coevolution.emftext.emig.language.emig.resource.emig.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigNature.activate(inputFile.getProject());
		...
		it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource loadedResource = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) {
					setResource((it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the EmigEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource textResource = (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextResource) element.eResource();
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigTextToken token = lexer.getNextToken();
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!EmigEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (it.univaq.coevolution.emftext.emig.language.emig.resource.emig.IEmigBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.IEmigBracketHandler bracketHandler) {
