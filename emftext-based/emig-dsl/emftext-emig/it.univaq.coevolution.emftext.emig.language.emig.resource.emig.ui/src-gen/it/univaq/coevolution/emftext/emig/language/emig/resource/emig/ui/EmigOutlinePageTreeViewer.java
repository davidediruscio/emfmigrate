 ...
 * a specified depth.
 */
public class EmigOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public EmigOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof it.univaq.coevolution.emftext.emig.language.emig.resource.emig.ui.EmigEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			it.univaq.coevolution.emftext.emig.language.emig.resource.emig.mopp.EmigPlugin.logError("Exception while refreshing outline view", e);
		}
	}
