 ...
 * olInput</code>.
 */
public class EmigDocBrowserInformationControlInput {
	
	private final EmigDocBrowserInformationControlInput fPrevious;
	private EmigDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EmigDocBrowserInformationControlInput(EmigDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EmigDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EmigDocBrowserInformationControlInput getNext() {
		return fNext;
	}
