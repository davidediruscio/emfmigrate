 ...
 */
public class EmigOclBracketSet {
	...
	private java.util.ArrayList<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair {
	 ...
	 */
	private class ClosingListener implements it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.IEmigOclBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public EmigOclBracketSet(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair>();
	 ...
	 */
	public it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair getBracketPair(String opening, String closing) {
		for (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair bracketPair : bracketPairs) {
	...
	public it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair remove(String opening, String closing) {
		for (it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
