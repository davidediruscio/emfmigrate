 ...
 * a specified depth.
 */
public class EmigOclOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public EmigOclOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclPlugin.logError("Exception while refreshing outline view", e);
		}
	}
