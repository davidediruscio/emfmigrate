 ...
 */
public class EmigOclBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource resource, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource resource, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource resource, final it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
