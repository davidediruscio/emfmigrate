 ...
 */
public class EmigOclImageProvider {
	
	public final static EmigOclImageProvider INSTANCE = new EmigOclImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
