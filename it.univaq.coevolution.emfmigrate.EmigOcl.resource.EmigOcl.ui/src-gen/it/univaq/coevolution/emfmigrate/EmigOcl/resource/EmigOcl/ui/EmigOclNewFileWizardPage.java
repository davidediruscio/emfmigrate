 ...
 */
public class EmigOclNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public EmigOclNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new EmigOcl file");
