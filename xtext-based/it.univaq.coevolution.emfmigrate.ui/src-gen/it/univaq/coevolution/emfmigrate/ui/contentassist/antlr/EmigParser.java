		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLocatedElementAccess().getAlternatives(), "rule__LocatedElement__Alternatives");
					...
					put(grammarAccess.getLocatedElementAccess().getGroup_0(), "rule__LocatedElement__Group_0__0");
					put(grammarAccess.getMigrationProgramAccess().getGroup(), "rule__MigrationProgram__Group__0");
					put(grammarAccess.getMigrationProgramAccess().getGroup_3(), "rule__MigrationProgram__Group_3__0");
					put(grammarAccess.getMigrationProgramAccess().getGroup_8(), "rule__MigrationProgram__Group_8__0");
					put(grammarAccess.getMigrationProgramAccess().getGroup_8_1(), "rule__MigrationProgram__Group_8_1__0");
					...
					put(grammarAccess.getMigrationLibraryAccess().getNameAssignment_1(), "rule__MigrationLibrary__NameAssignment_1");
					put(grammarAccess.getMigrationLibraryAccess().getRulesAssignment_3(), "rule__MigrationLibrary__RulesAssignment_3");
					put(grammarAccess.getLocatedElementAccess().getLineAssignment_0_0(), "rule__LocatedElement__LineAssignment_0_0");
					put(grammarAccess.getLocatedElementAccess().getEndlineAssignment_0_1(), "rule__LocatedElement__EndlineAssignment_0_1");
					put(grammarAccess.getLocatedElementAccess().getOffsetAssignment_0_2(), "rule__LocatedElement__OffsetAssignment_0_2");
					put(grammarAccess.getLocatedElementAccess().getEndoffsetAssignment_0_3(), "rule__LocatedElement__EndoffsetAssignment_0_3");
					put(grammarAccess.getMigrationProgramAccess().getNameAssignment_1(), "rule__MigrationProgram__NameAssignment_1");
					put(grammarAccess.getMigrationProgramAccess().getLibsAssignment_3_1(), "rule__MigrationProgram__LibsAssignment_3_1");
					put(grammarAccess.getMigrationProgramAccess().getMigrAssignment_4(), "rule__MigrationProgram__MigrAssignment_4");
					put(grammarAccess.getMigrationProgramAccess().getTypeArtAssignment_5(), "rule__MigrationProgram__TypeArtAssignment_5");
					put(grammarAccess.getMigrationProgramAccess().getArtifactAssignment_6(), "rule__MigrationProgram__ArtifactAssignment_6");
					put(grammarAccess.getMigrationProgramAccess().getTransformationPackageAssignment_8_0(), "rule__MigrationProgram__TransformationPackageAssignment_8_0");
					put(grammarAccess.getMigrationProgramAccess().getTransformationPackageAssignment_8_1_1(), "rule__MigrationProgram__TransformationPackageAssignment_8_1_1");
					put(grammarAccess.getMigrationProgramAccess().getDeltaAssignment_10(), "rule__MigrationProgram__DeltaAssignment_10");
					put(grammarAccess.getMigrationProgramAccess().getRulesAssignment_12(), "rule__MigrationProgram__RulesAssignment_12");
					...
					put(grammarAccess.getRewritingRuleAccess().getMigratorSXAssignment_0_0(), "rule__RewritingRule__MigratorSXAssignment_0_0");
