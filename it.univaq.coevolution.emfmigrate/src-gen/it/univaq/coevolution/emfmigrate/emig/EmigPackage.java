...
public interface EmigPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the attribute '{@link it.univaq.coevolution.emfmigrate.emig.Migrator#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see it.univaq.coevolution.emfmigrate.emig.Migrator#getName()
   * @see #getMigrator()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getFeatureSX <em>Feature SX</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Feature SX</em>'.
   * @see it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getFeatureSX()
  ...
  /**
   * Returns the meta object for the attribute '{@link it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getOp <em>Op</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Op</em>'.
   * @see it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getOp()
   * @see #getFilterMigrator()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the containment reference '{@link it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getValue <em>Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Value</em>'.
   * @see it.univaq.coevolution.emfmigrate.emig.FilterMigrator#getValue()
   * @see #getFilterMigrator()
   * @generated
   */
