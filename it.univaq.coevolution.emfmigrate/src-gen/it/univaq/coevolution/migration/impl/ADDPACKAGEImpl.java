...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>ADDPACKAGE</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.coevolution.migration.impl.ADDPACKAGEImpl#getOp <em>Op</em>}</li>
 *   <li>{@link it.univaq.coevolution.migration.impl.ADDPACKAGEImpl#getNew <em>New</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ADDPACKAGEImpl extends MinimalEObjectImpl.Container implements ADDPACKAGE
{
  ...
  {
    return MigrationPackage.Literals.ADDPACKAGE;
  }
  ...
  public void setOp(String newOp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.ADDPACKAGE__OP, oldOp, op));
  }
  ...
  public void setNew(String newNew)
  {
    ...
    new_ = newNew;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.ADDPACKAGE__NEW, oldNew, new_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MigrationPackage.ADDPACKAGE__OP:
        return getOp();
      case MigrationPackage.ADDPACKAGE__NEW:
        return getNew();
    }
