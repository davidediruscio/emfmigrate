...
public abstract class OclExpressionImpl extends LocatedElementImpl implements OclExpression {
	...
	public void setParentOperation(OperationCallExp newParentOperation) {
		if (newParentOperation != eInternalContainer() || (eContainerFeatureID() != EmigOclPackage.OCL_EXPRESSION__PARENT_OPERATION && newParentOperation != null)) {
			...
			if (newParentOperation != null)
				msgs = ((InternalEObject)newParentOperation).eInverseAdd(this, EmigOclPackage.OPERATION_CALL_EXP__ARGUMENTS, OperationCallExp.class, msgs);
	...
	public void setInitializedVariable(VariableDeclaration newInitializedVariable) {
		if (newInitializedVariable != eInternalContainer() || (eContainerFeatureID() != EmigOclPackage.OCL_EXPRESSION__INITIALIZED_VARIABLE && newInitializedVariable != null)) {
			...
			if (newInitializedVariable != null)
				msgs = ((InternalEObject)newInitializedVariable).eInverseAdd(this, EmigOclPackage.VARIABLE_DECLARATION__INIT_EXPRESSION, VariableDeclaration.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			...
			case EmigOclPackage.OCL_EXPRESSION__PARENT_OPERATION:
				return eInternalContainer().eInverseRemove(this, EmigOclPackage.OPERATION_CALL_EXP__ARGUMENTS, OperationCallExp.class, msgs);
			case EmigOclPackage.OCL_EXPRESSION__INITIALIZED_VARIABLE:
				return eInternalContainer().eInverseRemove(this, EmigOclPackage.VARIABLE_DECLARATION__INIT_EXPRESSION, VariableDeclaration.class, msgs);
			case EmigOclPackage.OCL_EXPRESSION__IF_EXP2:
