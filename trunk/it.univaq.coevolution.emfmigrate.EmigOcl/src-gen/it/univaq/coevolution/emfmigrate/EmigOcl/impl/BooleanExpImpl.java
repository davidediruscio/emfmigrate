 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.BooleanExpImpl#isBooleanSymbol <em>Boolean Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanExpImpl extends PrimitiveExpImpl implements BooleanExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.BOOLEAN_EXP;
	}
	...
	public void setBooleanSymbol(boolean newBooleanSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL, oldBooleanSymbol, booleanSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.BOOLEAN_EXP__BOOLEAN_SYMBOL:
