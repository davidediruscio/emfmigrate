 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.OclModelElementImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OclModelElementImpl extends OclTypeImpl implements OclModelElement {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.OCL_MODEL_ELEMENT;
	}
		...
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmigOclPackage.OCL_MODEL_ELEMENT__MODEL, oldModel, model));
			}
		}
		return model;
	}
	...
	public NotificationChain basicSetModel(OclModel newModel, NotificationChain msgs) {
		...
		model = newModel;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EmigOclPackage.OCL_MODEL_ELEMENT__MODEL, oldModel, newModel);
	...
	public void setModel(OclModel newModel) {
		if (newModel != model) {
			...
			if (model != null)
				msgs = ((InternalEObject)model).eInverseRemove(this, EmigOclPackage.OCL_MODEL__ELEMENTS, OclModel.class, msgs);
			if (newModel != null)
				msgs = ((InternalEObject)newModel).eInverseAdd(this, EmigOclPackage.OCL_MODEL__ELEMENTS, OclModel.class, msgs);
			msgs = basicSetModel(newModel, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.OCL_MODEL_ELEMENT__MODEL, newModel, newModel));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.OCL_MODEL_ELEMENT__MODEL:
				if (model != null)
					msgs = ((InternalEObject)model).eInverseRemove(this, EmigOclPackage.OCL_MODEL__ELEMENTS, OclModel.class, msgs);
