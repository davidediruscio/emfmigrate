 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.emig.impl.RuleImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.univaq.coevolution.emfmigrate.emig.impl.RuleImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link it.univaq.coevolution.emfmigrate.emig.impl.RuleImpl#getRewritingRules <em>Rewriting Rules</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RuleImpl extends LocatedElementImpl implements Rule
{
  /**
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmigPackage.RULE__NAME, oldName, name));
  }
  ...
  public EList<RewritingRule> getRewritingRules()
  {
    ...
    {
      rewritingRules = new EObjectContainmentEList<RewritingRule>(RewritingRule.class, this, EmigPackage.RULE__REWRITING_RULES);
    }
