...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>DELETEATTRIBUTE</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link it.univaq.coevolution.migration.impl.DELETEATTRIBUTEImpl#getRefAttr <em>Ref Attr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DELETEATTRIBUTEImpl extends MinimalEObjectImpl.Container implements DELETEATTRIBUTE
{
  ...
  {
    return MigrationPackage.Literals.DELETEATTRIBUTE;
  }
    ...
    if (refAttr != null && refAttr.eIsProxy())
    {
      ...
      if (refAttr != oldRefAttr)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, MigrationPackage.DELETEATTRIBUTE__REF_ATTR, oldRefAttr, refAttr));
      }
    }
    return refAttr;
  }
  ...
  public void setRefAttr(EAttribute newRefAttr)
  {
    ...
    refAttr = newRefAttr;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.DELETEATTRIBUTE__REF_ATTR, oldRefAttr, refAttr));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MigrationPackage.DELETEATTRIBUTE__REF_ATTR:
