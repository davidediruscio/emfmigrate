 ...
 * olInput</code>.
 */
public class EmigOclDocBrowserInformationControlInput {
	
	private final EmigOclDocBrowserInformationControlInput fPrevious;
	private EmigOclDocBrowserInformationControlInput fNext;
	 ...
	 */
	public EmigOclDocBrowserInformationControlInput(EmigOclDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public EmigOclDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public EmigOclDocBrowserInformationControlInput getNext() {
		return fNext;
	}
