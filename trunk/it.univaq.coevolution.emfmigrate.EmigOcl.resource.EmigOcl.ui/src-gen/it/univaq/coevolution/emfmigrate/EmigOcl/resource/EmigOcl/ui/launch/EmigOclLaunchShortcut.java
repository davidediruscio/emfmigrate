 ...
 */
public class EmigOclLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.launch.EmigOclLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclPlugin.logError("Exception while launching selection", e);
		}
	}
