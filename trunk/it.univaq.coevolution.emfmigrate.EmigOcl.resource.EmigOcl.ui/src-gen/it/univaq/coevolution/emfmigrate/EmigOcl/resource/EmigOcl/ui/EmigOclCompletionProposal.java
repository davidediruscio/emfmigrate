 ...
 */
public class EmigOclCompletionProposal implements java.lang.Comparable<EmigOclCompletionProposal> {
	...
	public EmigOclCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public EmigOclCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public EmigOclCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof EmigOclCompletionProposal) {
			EmigOclCompletionProposal other = (EmigOclCompletionProposal) object;
	...
	public int compareTo(EmigOclCompletionProposal object) {
		if (object instanceof EmigOclCompletionProposal) {
			EmigOclCompletionProposal other = (EmigOclCompletionProposal) object;
