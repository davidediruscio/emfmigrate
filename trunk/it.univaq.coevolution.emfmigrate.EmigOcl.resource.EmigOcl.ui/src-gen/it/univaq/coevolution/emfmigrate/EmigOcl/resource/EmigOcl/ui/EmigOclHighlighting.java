 ...
 */
public class EmigOclHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionHelper positionHelper = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionHelper();
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclTokenScanner scanner;
	...
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclOccurrence occurrence;
	private it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public EmigOclHighlighting(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclColorManager colorManager, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclTokenScanner(textResource, colorManager);
		occurrence = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui.EmigOclEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
