 ...
 */
public class EmigOclNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public EmigOclNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.ui");
							...
							String natureID = it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclNature.NATURE_ID;
							...
							for (String builderID : it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation info = new it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclMetaInformation();
