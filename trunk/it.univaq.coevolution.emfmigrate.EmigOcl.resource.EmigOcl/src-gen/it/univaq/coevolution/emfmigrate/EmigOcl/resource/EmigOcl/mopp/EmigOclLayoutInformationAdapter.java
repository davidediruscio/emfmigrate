...
/**
 * A EmigOclLayoutInformationAdapter is used to store layout information that is
 ...
 * EmigOclLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class EmigOclLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclLayoutInformation> layoutInformations = new java.util.ArrayList<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclLayoutInformation>();
	...
	public java.util.List<it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclLayoutInformation layoutInformation) {
