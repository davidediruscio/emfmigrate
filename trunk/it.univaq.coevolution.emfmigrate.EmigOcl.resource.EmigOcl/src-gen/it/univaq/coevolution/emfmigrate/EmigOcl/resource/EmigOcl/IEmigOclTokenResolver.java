 ...
 * instance of EmigOclDefaultTokenResolver which performs a standard conversion
 * based on the EMF type conversion. This includes conversion of registered
 * EDataTypes.
 * 
 * @see
 * it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.analysis.EmigOclDefaul
 * tTokenResolver
 */
public interface IEmigOclTokenResolver extends it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclConfigurable {
