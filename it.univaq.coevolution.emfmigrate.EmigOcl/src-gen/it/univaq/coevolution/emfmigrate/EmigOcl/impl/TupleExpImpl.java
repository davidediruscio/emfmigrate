 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.TupleExpImpl#getTuplePart <em>Tuple Part</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TupleExpImpl extends OclExpressionImpl implements TupleExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.TUPLE_EXP;
	}
	...
	public EList<TuplePart> getTuplePart() {
		if (tuplePart == null) {
			tuplePart = new EObjectContainmentWithInverseEList<TuplePart>(TuplePart.class, this, EmigOclPackage.TUPLE_EXP__TUPLE_PART, EmigOclPackage.TUPLE_PART__TUPLE);
		}
		return tuplePart;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.TUPLE_EXP__TUPLE_PART:
