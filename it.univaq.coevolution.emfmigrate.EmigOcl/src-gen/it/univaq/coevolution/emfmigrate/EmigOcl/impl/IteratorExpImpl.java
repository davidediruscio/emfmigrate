 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.IteratorExpImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IteratorExpImpl extends LoopExpImpl implements IteratorExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.ITERATOR_EXP;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.ITERATOR_EXP__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.ITERATOR_EXP__NAME:
				return getName();
		}
