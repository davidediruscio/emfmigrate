 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.IntegerExpImpl#getIntegerSymbol <em>Integer Symbol</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerExpImpl extends NumericExpImpl implements IntegerExp {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.INTEGER_EXP;
	}
	...
	public void setIntegerSymbol(int newIntegerSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.INTEGER_EXP__INTEGER_SYMBOL, oldIntegerSymbol, integerSymbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmigOclPackage.INTEGER_EXP__INTEGER_SYMBOL:
