 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.emfmigrate.EmigOcl.impl.IteratorImpl#getLoopExpr <em>Loop Expr</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IteratorImpl extends VariableDeclarationImpl implements Iterator {
	...
	protected EClass eStaticClass() {
		return EmigOclPackage.Literals.ITERATOR;
	}
	...
	public LoopExp getLoopExpr() {
		if (eContainerFeatureID() != EmigOclPackage.ITERATOR__LOOP_EXPR) return null;
	...
	public NotificationChain basicSetLoopExpr(LoopExp newLoopExpr, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newLoopExpr, EmigOclPackage.ITERATOR__LOOP_EXPR, msgs);
		return msgs;
	}
	...
	public void setLoopExpr(LoopExp newLoopExpr) {
		if (newLoopExpr != eInternalContainer() || (eContainerFeatureID() != EmigOclPackage.ITERATOR__LOOP_EXPR && newLoopExpr != null)) {
			...
			if (newLoopExpr != null)
				msgs = ((InternalEObject)newLoopExpr).eInverseAdd(this, EmigOclPackage.LOOP_EXP__ITERATORS, LoopExp.class, msgs);
			msgs = basicSetLoopExpr(newLoopExpr, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmigOclPackage.ITERATOR__LOOP_EXPR, newLoopExpr, newLoopExpr));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EmigOclPackage.ITERATOR__LOOP_EXPR:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case EmigOclPackage.ITERATOR__LOOP_EXPR:
				return eInternalContainer().eInverseRemove(this, EmigOclPackage.LOOP_EXP__ITERATORS, LoopExp.class, msgs);
		}
