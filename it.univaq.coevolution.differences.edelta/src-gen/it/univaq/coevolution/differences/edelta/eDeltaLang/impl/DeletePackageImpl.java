 ...
 * <ul>
 *   <li>{@link it.univaq.coevolution.differences.edelta.eDeltaLang.impl.DeletePackageImpl#getRef <em>Ref</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DeletePackageImpl extends MinimalEObjectImpl.Container implements DeletePackage
{
  ...
  {
    return EDeltaLangPackage.Literals.DELETE_PACKAGE;
  }
    ...
    if (ref != null && ref.eIsProxy())
    {
      ...
      if (ref != oldRef)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, EDeltaLangPackage.DELETE_PACKAGE__REF, oldRef, ref));
      }
    }
    return ref;
  }
  ...
  public void setRef(EPackage newRef)
  {
    ...
    ref = newRef;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EDeltaLangPackage.DELETE_PACKAGE__REF, oldRef, ref));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EDeltaLangPackage.DELETE_PACKAGE__REF:
