 ...
 */
public class EmigOclDefaultTokenResolver implements it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTokenResolver {
	 ...
	 */
	public EmigOclDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public EmigOclDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.IEmigOclTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.grammar.EmigOclGrammarInformationProvider.INSTANCE.getKeywords()) {
