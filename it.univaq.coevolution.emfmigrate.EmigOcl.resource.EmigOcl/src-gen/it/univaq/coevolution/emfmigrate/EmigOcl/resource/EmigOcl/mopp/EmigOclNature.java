...
public class EmigOclNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
