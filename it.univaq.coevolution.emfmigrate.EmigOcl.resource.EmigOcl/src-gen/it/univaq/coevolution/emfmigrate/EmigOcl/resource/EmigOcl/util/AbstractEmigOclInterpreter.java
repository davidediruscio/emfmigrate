...
public class AbstractEmigOclInterpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof it.univaq.coevolution.emfmigrate.EmigOcl.OperationCallExp) {
			result = interprete_it_univaq_coevolution_emfmigrate_EmigOcl_OperationCallExp((it.univaq.coevolution.emfmigrate.EmigOcl.OperationCallExp) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof it.univaq.coevolution.emfmigrate.EmigOcl.NavigationOrAttributeCallExp) {
			result = interprete_it_univaq_coevolution_emfmigrate_EmigOcl_NavigationOrAttributeCallExp((it.univaq.coevolution.emfmigrate.EmigOcl.NavigationOrAttributeCallExp) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_it_univaq_coevolution_emfmigrate_EmigOcl_NavigationOrAttributeCallExp(it.univaq.coevolution.emfmigrate.EmigOcl.NavigationOrAttributeCallExp object, ContextType context) {
		return null;
	}
	
	public ResultType interprete_it_univaq_coevolution_emfmigrate_EmigOcl_OperationCallExp(it.univaq.coevolution.emfmigrate.EmigOcl.OperationCallExp object, ContextType context) {
		return null;
	}
