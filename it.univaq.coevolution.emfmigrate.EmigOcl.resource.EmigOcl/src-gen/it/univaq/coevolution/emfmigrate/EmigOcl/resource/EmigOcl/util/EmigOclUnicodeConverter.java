 ...
 * to 4 bytes).
 */
public class EmigOclUnicodeConverter extends it.univaq.coevolution.emfmigrate.EmigOcl.resource.EmigOcl.mopp.EmigOclInputStreamProcessor {
	 ...
	 */
	public EmigOclUnicodeConverter(java.io.InputStream inputStream) {
